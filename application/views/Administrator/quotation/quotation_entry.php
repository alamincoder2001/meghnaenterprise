				...
				<div class="widget-main">
					...
					<div class="row">
						...
						<div class="form-group clearfix">
								...
								<div class="col-sm-8">
								<v-select id="branchDropdown" v-bind:options="customers" label="Customer_Name" v-model="selectedCustomer" v-on:input="onChageCustomer"></v-select>
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="Rate" class="form-control" v-model="selectedProduct.Product_SellingPrice" v-on:input="productTotal"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> Quantity </label>
									<div class="col-sm-9">
										<input type="text" id="quantity" placeholder="Qty" class="form-control" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required/>
									</div>
								</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control" v-model="quotation.subTotal" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" v-model="vatPercent" v-on:input="calculateTotal"/>
												</div>
												<label class="col-sm-1 control-label no-padding-right">%</label>
												<div class="col-sm-7">
													<input type="text" readonly class="form-control" v-model="quotation.vat"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" v-model="discountPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-sm-1 control-label no-padding-right">%</label>

												<div class="col-sm-7">
													<input type="text" id="discount" class="form-control" v-model="quotation.discount" v-on:input="calculateTotal"/>
												</div>
									...
									<tr> 
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control" v-model="quotation.total" readonly />
												</div>
											</div>
										</td>
									</tr>
