...
<div id="salesRecord">
    <p style="margin:0;padding:0;font-weight: bold">Quotation Pending List</p>
			...
			<div class="table-responsive" id="reportContent">
						...
						<template v-for="sale in sales">
							<tr>
								...
								<td style="text-align:center;">
									...
									<a href="" title="Edit Sale" v-bind:href="`/sales/quotation/${sale.SaleMaster_SlNo}`"><i class="fa fa-edit"></i></a>
									<a href="" title="Delete Sale" @click.prevent="deleteSale(sale.SaleMaster_SlNo)"><i class="fa fa-trash"></i></a>

									<?php }?>
									
									<a href="" title=" Sale" @click.prevent="confirmOrder(sale.SaleMaster_SlNo)"><i class="fa fa-check"></i></a>
				...
				<table 
					...
					<tr style="font-weight:bold;">
							...
							<td  style="text-align:right;"> {{ sales.reduce((pre,next)=>{
								          return pre+parseFloat(next.SaleDetails_Rate)
							},0) }} </td>
		...
		methods: {
            async confirmOrder(id){
				if(confirm('Are you sure delete this?')){
					await axios.post(`/order_confirm`,{id}).then((res=>{
