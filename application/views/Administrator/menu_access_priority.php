        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="sales/quotation" v-model="access"> Quotation Entry</li>
                    <li><input type="checkbox" class="access" value="quotationrecord" v-model="access"> Quotation Record</li>
                    <li><input type="checkbox" class="access" value="ordersrecord" v-model="access"> Pending order record</li>
                </ul>
            </div>
