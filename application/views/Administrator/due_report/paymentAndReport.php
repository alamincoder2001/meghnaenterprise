            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody> 
                        ...
                        <td style="text-align:right;"><?php if($type == 'DC'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></td>
                        ...
                        <tr>
                            ...
                            <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php if($type == 'DC'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></th>
