...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("ordersrecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>ordersrecord"> 
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text" style="font-size:12px;">  Order undeliver Record </span>
				</a>
				<b class="arrow"></b> 
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("quotationrecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>quotation_record"> 
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text" style="font-size:12px;">  quotation record  </span>
				</a>
				<b class="arrow"></b> 
			</li>
		<?php endif; ?>
