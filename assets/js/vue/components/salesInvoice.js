const salesInvoice = Vue.component("sales-invoice", {
            ...
            <div id="invoiceContent">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <div _h098asdh style="font-size: 20px;">
                            {{sales.Status=='p'?'Order Invoice ':'Sales Invoice '}}
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        <strong> {{sales.Status=='p'?'Order  ':'Sales  '}}  by:</strong> {{ sales.AddBy }}<br>
                        <strong>Invoice No.:</strong> {{ sales.SaleMaster_InvoiceNo }}<br>
                        <strong> {{sales.Status=='p'?'Order  ':'Sales  '}} Date:</strong> {{ sales.SaleMaster_SaleDate }} {{ sales.AddTime | formatDateTime('h:mm a') }}<br>
                ...
                <div class="row">
                    <div class="col-xs-6" >
                        <br>
                        <table class="pull-left" v-if="due==true" >
                            <tr>
                                <td><strong v-on:click="dueHide">Previous Due:</strong></td> 
    ...
    methods: {
        ...
        async getSales() {
            let status = "";
            await axios.post("/check_inv", { salesId: this.sales_id }).then((res) => {
                ...
                printWindow.document.write(`
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            @media print{
                                @page{size: auto;margin: .5in .5in .5in .5in;}
                            }
                        </style>
                    </head>
                    <body>                        
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    <div class="row">
                                        <div class="col-xs-2"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:100%;width:100%;" /></div>
                                            <div class="col-xs-10">
                                                <strong style="font-size: 24px;text-align: center;">${this.currentBranch.Company_Name}</strong>
                                                <br>
                                                <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                                            </div>
                                            <div class="col-xs-12">
                                        ...
                                        <div col-xs-12>
                                            <p style="text-align:center;width:100%;font-width:bold;color:#222;font-size:13px;">** Before You Receive Product Please Do Check it. After Receiving, any kind of Objection will not be acceptable. 
                                            <br>BIN : 0032609650401**</p>                                
                                        </div>
                                        <div class="col-xs-12">
                                            <div style="position: sticky;bottom:0;left:0;width:100%;margin-top:60px;">
